    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/kanri')) {
            ...
            if (0 === strpos($pathinfo, '/kanri/s')) {
                ...
                elseif (0 === strpos($pathinfo, '/kanri/sheeb_expand_product_column')) {
                    // 
                    if (0 === strpos($pathinfo, '/kanri/sheeb_expand_product_column/column_value') && preg_match('#^/kanri/sheeb_expand_product_column/column_value/(?P<product_id>\\d+)/(?P<column_id>\\d+)/(?P<sequence>\\d+)/add/(?P<number>\\d+)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, ['_route' => '']), array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ApiController::createElement',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                    ...
                    if (0 === strpos($pathinfo, '/kanri/sheeb_expand_product_column/config')) {
                        // sheeb_expand_product_column_admin_config
                        if ('/kanri/sheeb_expand_product_column/config' === $pathinfo) {
                            $ret = array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ConfigController::index',  '_route' => 'sheeb_expand_product_column_admin_config',);
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_sheeb_expand_product_column_admin_config;
                                }

                                return array_replace($ret, $this->redirect($rawPathinfo, 'sheeb_expand_product_column_admin_config', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_sheeb_expand_product_column_admin_config:

                        // sheeb_expand_product_column_admin_config_new
                        if ('/kanri/sheeb_expand_product_column/config/new' === $pathinfo) {
                            $ret = array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ConfigController::create',  '_route' => 'sheeb_expand_product_column_admin_config_new',);
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_sheeb_expand_product_column_admin_config_new;
                                }

                                return array_replace($ret, $this->redirect($rawPathinfo, 'sheeb_expand_product_column_admin_config_new', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_sheeb_expand_product_column_admin_config_new:

                        // sheeb_expand_product_column_admin_config_edit
                        if (preg_match('#^/kanri/sheeb_expand_product_column/config/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'sheeb_expand_product_column_admin_config_edit']), array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ConfigController::edit',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_sheeb_expand_product_column_admin_config_edit;
                                }

                                return array_replace($ret, $this->redirect($rawPathinfo, 'sheeb_expand_product_column_admin_config_edit', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_sheeb_expand_product_column_admin_config_edit:

                        // sheeb_expand_product_column_admin_config_delete
                        if (preg_match('#^/kanri/sheeb_expand_product_column/config/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'sheeb_expand_product_column_admin_config_delete']), array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ConfigController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, ['DELETE'])) {
                                if ($hasRequiredScheme) {
                                ...
                                goto not_sheeb_expand_product_column_admin_config_delete;
                            }
                            if (!$hasRequiredScheme) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_sheeb_expand_product_column_admin_config_delete;
                                ...
                                return array_replace($ret, $this->redirect($rawPathinfo, 'sheeb_expand_product_column_admin_config_delete', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_sheeb_expand_product_column_admin_config_delete:

                    }

                    // sheeb_expand_product_column_image_add
                    if ('/kanri/sheeb_expand_product_column/image/add' === $pathinfo) {
                        $ret = array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ApiController::addImage',  '_route' => 'sheeb_expand_product_column_image_add',);
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                        if (!in_array($requestMethod, ['POST'])) {
                            if ($hasRequiredScheme) {
                            ...
                            goto not_sheeb_expand_product_column_image_add;
                        }
                        if (!$hasRequiredScheme) {
                            if ('GET' !== $canonicalMethod) {
                                goto not_sheeb_expand_product_column_image_add;
                            ...
                            return array_replace($ret, $this->redirect($rawPathinfo, 'sheeb_expand_product_column_image_add', key($requiredSchemes)));
                        }

                        return $ret;
                    }
                    not_sheeb_expand_product_column_image_add:
            ...
            elseif (0 === strpos($pathinfo, '/kanri/c')) {
                ...
                if (0 === strpos($pathinfo, '/kanri/content')) {
                    ...
                    if (0 === strpos($pathinfo, '/kanri/content/news')) {
                        // admin_content_news
                    ...
                    elseif (0 === strpos($pathinfo, '/kanri/content/page')) {
                        // admin_content_page
            ...
            elseif (0 === strpos($pathinfo, '/kanri/product')) {
                ...
                elseif (0 === strpos($pathinfo, '/kanri/product/product/class')) {
                ...
                if (0 === strpos($pathinfo, '/kanri/product/product')) {
                    ...
                    if ('/kanri/product/product_csv_upload' === $pathinfo) {
                        $ret = array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ProductCsvImportController::csvProduct',  '_route' => 'admin_product_csv_import',);
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                ...
                elseif (0 === strpos($pathinfo, '/kanri/product/c')) {
                    ...
                    if ('/kanri/product/category_csv_upload' === $pathinfo) {
                        $ret = array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ProductCsvImportController::csvCategory',  '_route' => 'admin_product_category_csv_import',);
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                    ...
                    if (0 === strpos($pathinfo, '/kanri/product/csv_template') && preg_match('#^/kanri/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                        $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_product_csv_template']), array (  '_controller' => 'Plugin\\SheebExpandProductColumn\\Controller\\ProductCsvImportController::csvTemplate',));
                        $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                        if (!isset($requiredSchemes[$context->getScheme()])) {
                            if ('GET' !== $canonicalMethod) {
                ...
                if (0 === strpos($pathinfo, '/kanri/product/tag')) {
                    // admin_product_tag
