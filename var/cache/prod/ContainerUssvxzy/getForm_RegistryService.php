...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Form\\Type\\AddCartType' => function () {
...
}, 'Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\CheckBoxType' => function () {
    return ${($_ = isset($this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\CheckBoxType']) ? $this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\CheckBoxType'] : ($this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\CheckBoxType'] = new \Plugin\SheebExpandProductColumn\Form\Type\Admin\CheckBoxType())) && false ?: '_'};
}, 'Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\ColumnValueType' => function () {
    return ${($_ = isset($this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\ColumnValueType']) ? $this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\ColumnValueType'] : $this->load('getColumnValueTypeService.php')) && false ?: '_'};
}, 'Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\CustomFileType' => function () {
    return ${($_ = isset($this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\CustomFileType']) ? $this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\CustomFileType'] : $this->load('getCustomFileTypeService.php')) && false ?: '_'};
}, 'Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\ProductColumnConfigType' => function () {
    return ${($_ = isset($this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\ProductColumnConfigType']) ? $this->services['Plugin\\SheebExpandProductColumn\\Form\\Type\\Admin\\ProductColumnConfigType'] : $this->load('getProductColumnConfigTypeService.php')) && false ?: '_'};
    ...
    yield 0 => ${($_ = isset($this->services['Plugin\\SheebExpandProductColumn\\Form\\Extension\\ProductTypeExtension']) ? $this->services['Plugin\\SheebExpandProductColumn\\Form\\Extension\\ProductTypeExtension'] : $this->load('getProductTypeExtensionService.php')) && false ?: '_'};
